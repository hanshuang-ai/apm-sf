---
name: tc-brownfield-validate
description: 用于验证 spec-kit 配置是否符合实际的项目结构和规范
---

# Validate Bootstrap

Verify that the spec-kit configuration generated by `/tc-brownfield-bootstrap` accurately reflects the actual project structure, conventions, and architecture. Reports mismatches and suggests corrections.
